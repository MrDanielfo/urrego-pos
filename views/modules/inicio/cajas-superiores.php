<?php
	...
	$totalNeto = SellsController::conteoNetoVentas();
	...
	$categorias = CategoriesController::mostrarCategoriasFrontal($item, $valor);
...
<div class="col-lg-3 col-xs-6">
  ...
  <div class="small-box bg-aqua">
    <div class="inner">
      <h3><?php echo number_format($totalNeto['total'], 2);   ?></h3>
